...
namespace Crosstales.TPB.Util
{
   ...
   {
      private static readonly string fileMethods = System.IO.Path.GetTempPath() + "TPB_Methods.log";
      private static readonly string fileLog = System.IO.Path.GetTempPath() + "TPB.log";
